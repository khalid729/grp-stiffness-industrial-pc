  ...
  return (
    <div className="portrait-container">
      ...
      <header className="flex-shrink-0 flex flex-col gap-1.5 p-2 pt-4 border-b border-border bg-background">
        ...
        {/* Row 2: Safety + Machine Indicators | Mode Toggle | Emergency Button */}
        <div className="flex items-center gap-2">
          {/* Indicators */}
          ...
          {/* Mode Toggle - centered in remaining space before E-Stop */}
      ...
      {/* Main Content */}
      <main className="main-content p-2 pb-20">
        {children}
      </main>
