...
const translations: Translations = {
  ...
  "testSetup.isoNote": { en: "Parameters according to ASTM D2412 standard", ar: "المعاملات وفقاً لمعيار ASTM D2412" },
  ...
  "dashboard.group.fracture": { en: "Fracture Test", ar: "اختبار الكسر" },
  "dashboard.fractureMax": { en: "Fracture Max Deflection", ar: "أقصى انحراف للكسر" },
  ...
  "testSetup.angle": { en: "Angle", ar: "الزاوية" },
  "testSetup.placeAtAngle": { en: "Place sample at angle", ar: "ضع العينة على الزاوية" },
  "testSetup.nextPosition": { en: "Next Position", ar: "الموضع التالي" },
  "testSetup.retryPosition": { en: "Retry Position", ar: "إعادة الموضع" },
  "testSetup.groupComplete": { en: "All positions complete", ar: "اكتملت جميع المواضع" },
  "testSetup.avgStiffness": { en: "Average Pipe Stiffness (STIS)", ar: "متوسط صلابة الحلقة" },
  ...
  "testSetup.crackStandalone": { en: "Standalone", ar: "مستقل" },
  "testSetup.crackLinked": { en: "Link to Previous", ar: "ربط باختبار سابق" },
  "testSetup.crackLinkedTo": { en: "Linked to Test", ar: "مربوط بالاختبار" },
  ...
  "testSetup.sampleMeasurements": { en: "Sample Measurements", ar: "قياسات العينة" },
  "testSetup.horizontalId": { en: "Horizontal ID", ar: "القطر الأفقي" },
  "testSetup.verticalId": { en: "Vertical ID", ar: "القطر العمودي" },
  "testSetup.wallThickness": { en: "Wall Thickness", ar: "سُمك الجدار" },
  "testSetup.ringLength": { en: "Ring Length", ar: "طول الحلقة" },
  "testSetup.initialDeflection": { en: "Initial Deflection", ar: "الانحراف الابتدائي" },
  "results.stis": { en: "Pipe Stiffness (STIS)", ar: "صلابة الأنبوب (STIS)" },
  "results.eiOverR3": { en: "EI/R³", ar: "EI/R³" },
  "results.eModulus": { en: "E-Modulus", ar: "معامل المرونة" },
  ...
  "testSetup.stiffnessOnly": { en: "Stiffness Only - Return", ar: "ستفنيس فقط - ارجع" },
  "testSetup.deflectionAt": { en: "Deflection at", ar: "الانحراف عند" },
  "testSetup.forceAt": { en: "Force at", ar: "القوة عند" },
  ...
  // Report
  "report.title": { en: "Pipe Stiffness Test Report", ar: "تقرير اختبار صلابة الأنبوب" },
  ...
  "report.ringStiffness": { en: "Pipe Stiffness (STIS)", ar: "صلابة الأنبوب (STIS)" },
